        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 flex flex-col md:flex-row">
              ...
              <div className="p-10 md:p-14 md:w-2/5 bg-brand-900 text-white flex flex-col justify-between relative overflow-hidden">
                {/* Background Decor */}
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-8">
            Check out our frequently asked questions or contact our admissions
            team.
          </p>
          <div className="flex justify-center gap-4">
            <Link
              to="/faq"
              className="inline-flex items-center gap-2 bg-white text-gray-700 px-6 py-3 rounded-lg font-bold border border-gray-200 hover:bg-gray-50 transition-colors"
            >
