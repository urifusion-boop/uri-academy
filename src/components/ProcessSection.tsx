...
const steps = [
  {
    icon: BookOpen,
    title: "The Academy",
    description: "Master modern sales psychology and the Uri Tech Stack.",
  },
  {
    icon: Target,
    title: "The Residency",
    description: "Don't just study. Generate live leads for real companies using Uri. Earn commissions while you learn.",
  },
  {
    icon: Rocket,
    title: "The Deployment",
    description: "Top 5% get hired by Uri. The rest get placed with our partner network.",
  },
];
