              ...
              <div className="mt-20 text-center">
                <div className="bg-brand-50 rounded-3xl p-10 md:p-16">
                  ...
                  <div className="flex flex-col sm:flex-row justify-center gap-4">
                    <Link
                      href="/register"
                      className="btn-primary py-4 px-8 text-lg shadow-xl shadow-brand-200 inline-flex items-center justify-center"
                    >
                    ...
                    <Link
                      href="/pricing"
                      className="px-8 py-4 bg-white text-gray-700 font-bold rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors inline-flex items-center justify-center"
                    >
                      View Tuition
                    </Link>
                  </div>
