  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.free && response.tokens) {
        ...
        addToast("You've been enrolled for free! Set a password to continue.", 'success');
      ...
      if (err instanceof Error) {
        if (err.name === 'AbortError') {
          ...
          (err.message.toLowerCase().includes('discount') ||
      ...
      <div className="animate-fade-in">
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <p className="text-sm text-gray-600">
              Secure your spot now and pay the balance later. Total: ₦35,000
            </p>
          </div>
      ...
      <form className="space-y-6" onSubmit={handleRegister}>
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="block w-full px-3 py-3 border border-gray-300 rounded-lg focus:ring-brand-500 focus:border-brand-500 transition-colors uppercase"
        ...
        >
          {loading ? (
            ...
            <>
              Proceed to Payment (₦
              {paymentPlan === 'full' ? '35,000' : '20,000'})
            </>
          )}
